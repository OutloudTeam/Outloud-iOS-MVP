...
let darkRed = UIColor(red: 0.027, green: 0.11, blue: 0.145 , alpha: 1)
let transparentBlack = UIColor(red: 0.137, green: 0.122, blue: 0.125, alpha: 0.3)
let controlBarColor = UIColor(red: 56/255, green: 17/255, blue: 18/255, alpha: 1.0);
...
let yellowColor = UIColor(red:0.96, green:0.80, blue:0.30, alpha:1.0)
let redColor = UIColor(red:0.75, green:0.23, blue:0.16, alpha:1.0)
let blackColor = UIColor(red:0.14, green:0.12, blue:0.13, alpha:1.0)
//yellow: F6CC4C
//red: C03A29
//Black: 231F20
//Bright Red: BE2025
